...
from log_view.predicate import Query, LessThanConstant
...
def run_evaluation(log, variable_name, variable_values, len_result_set, len_complement_result_set):
    ...
    filter = Query('query', LessThanConstant(variable_name, variable_values))
...
def test_eq_predicate():
    ...
    run_evaluation(initial_source_log, 'Var2', 1.3, 5, 2)
